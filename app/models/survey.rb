class Survey < ActiveRecord::Base
  ...
  def obtain_sg_details
      ...
      resp_json = SgApi.get_sg_survey_responses(self.sg_id)
      resp_json_parsed = JSON.parse(resp_json)
      self.response_count = resp_json_parsed['total_count'].to_i
	  	self.responses_json = resp_json
	  end
  end
